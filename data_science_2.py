...
def page_rate_company():
    ...
    if first_name and last_name:
        ...
        st.metric("🏗️ Условия труда", avg_work_conditions)
        ...
        if worked == 'Нет':
            ...
            work_conditions = st.slider("🏗️ Оцените условия труда", 1, 5)
        ...
        st.warning("⚠️ Пожалуйста, введите ваше имя и фамилию для продолжения.")
