...
specialty_keywords = {
    ...
    "Мультимедиа и телевизионная журналистика": ["журналист", "СМИ", "телевидение", "видеопроизводство", "оператор", "редактор", "телевизионная журналистика", "мультимедийный контент", "новости", "продюсер"],
